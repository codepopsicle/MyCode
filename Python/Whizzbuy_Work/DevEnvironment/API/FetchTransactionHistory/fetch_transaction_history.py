				...
				if len(cities):
					...
					for city in cities:
						...
						for item in data1:
							...
							cursor = conn.cursor()
							query = "SELECT TransactionID, TransactionDate, RcptAmount FROM transactionmasterlist WHERE TranCity = %s and Locality = %s and CustomerID = %s and CompanyName = %s and TransactionVerified = 1"
