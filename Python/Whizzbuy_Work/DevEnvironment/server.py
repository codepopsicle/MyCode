...
app.config['MYSQL_DATABASE_USER'] = 'whizzbuydev'
app.config['MYSQL_DATABASE_PASSWORD'] = 'whizzbuydev'
app.config['MYSQL_DATABASE_DB'] = 'whizzbuydev'
app.config['MYSQL_DATABASE_HOST'] = 'whizzbuydev.c1vkqotq7mru.us-west-2.rds.amazonaws.com'
...
from API.ContactUs import ContactUs as ContactUs_blueprint
from API.SetAdLikeStatus import SetAdLikeStatus as SetAdLikeStatus_blueprint
from API.BillGenerator import BillGenerator as BillGenerator_blueprint
from API.ReturnURL import ReturnURL as ReturnURL_blueprint
from API.FetchAdDetail import FetchAdDetail as FetchAdDetail_blueprint
from API.FetchSavedAd import FetchSavedAd as FetchSavedAd_blueprint
from API.FetchGraph import FetchGraph as FetchGraph_blueprint
from API.FetchPieGraph import FetchPieGraph as FetchPieGraph_blueprint
from API.FetchDataPoint import FetchDataPoint as FetchDataPoint_blueprint
...
app.register_blueprint(ContactUs_blueprint)
app.register_blueprint(SetAdLikeStatus_blueprint)
app.register_blueprint(BillGenerator_blueprint)
app.register_blueprint(ReturnURL_blueprint)
app.register_blueprint(FetchAdDetail_blueprint)
app.register_blueprint(FetchSavedAd_blueprint)
app.register_blueprint(FetchGraph_blueprint)
app.register_blueprint(FetchPieGraph_blueprint)
app.register_blueprint(FetchDataPoint_blueprint)
