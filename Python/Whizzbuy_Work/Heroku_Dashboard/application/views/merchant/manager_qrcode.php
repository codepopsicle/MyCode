    ...
    <header  id="wrap">
        <div class="head-navbar" style="background:#99FFCC;">
            ...
            <ul class="nav nav-tabs" style="padding-left:20px;">
              ...
              <li role="presentation"><a href="<?php echo base_url('index.php/home/manager') ?>"><i class="fa fa-inr"></i> Transactions</a></li>
              <li role="presentation "  class="active"><a href="<?php echo base_url('index.php/home/manager_qrcode') ?>"><i class="fa fa-qrcode"></i> QR Code</a></li>
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Outlet Name: </label>
                            <div class="col-sm-2">
                              <!-- <p id="data2">Nat7</p> -->
                              <?php foreach ($records2 as $row): ?>
                              <p id="data2"><?php if($row->username === $username) echo $row->locality; ?></p>
                              <?php endforeach; ?>
                              <!-- <select id="data2">
                                <?php foreach ($records2 as $row): ?>
                                <option value="<?php echo $row->outletid; ?>"><?php echo $row->uniqueoutletcode; ?></option>
                                <?php endforeach; ?>
                              </select> -->
                            </div>
                      </div>
                      <div class="form-group">
                        <input type="hidden" id="data2" value="<?php echo $row->outletid; ?>">
