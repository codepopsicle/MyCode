        ...
        <!-- BEGIN TAB PORTLET-->
                            <div class="portlet light ">
                                <div class="caption" style="height: 40px">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase">Transactions</span>
                                </div>
...
<input id="apply" type="submit" value="Apply" class="btn btn-success"></input>
                        ...
                        <ul class="nav nav-tabs">
                                        <li>
                                            <a id="daytab" href="#portlet_tab3" data-toggle="tab"> Day </a>
                                        </li>
                                        <li class="active">
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="portlet_tab2">
                                            <div class="row" id="transactions_metrics_month">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="portlet light bordered">
                                                                ...
                                                                <div class="portlet-body">
                                                                    <div id="chart_1_2" class="chart" style="height: 300px;"> </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- END CHART PORTLET-->
                                        ...
                                        <div class="tab-pane" id="portlet_tab3">
                                            <div class="row" id="transactions_metrics_day">
                                                <script src="<?php echo base_url('assets/global/plugins/jquery.min.js'); ?>" type="text/javascript"></script>
                                                <input type="hidden" name="jsonarray" value="<?php echo htmlspecialchars($transaction_by_day_count,ENT_QUOTES); ?>" >
                                                <div class="col-md-12">
                                                    <!-- BEGIN ROW -->
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="portlet light bordered">
                                                                ...
                                                                <div class="portlet-body">
                                                                    <div id="chart_1_3" class="chart" style="height: 300px;"> </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- END CHART PORTLET-->
...
<script type="text/javascript">
  ...
  "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    ...
    $('#start').val(startdate);
    $('#end').val(enddate);
    $("#form1").attr("action","<?php echo base_url('index.php/merchant/transactions_performance_metrics_1'); ?>");
    ...
    <?php startblock('page_level_scripts'); ?>
      <!-- BEGIN  PAGE LEVEL SCRIPTS -->      
        <script src="<?php echo base_url('assets/pages/scripts/transactions_pmetrics.js'); ?>" type="text/javascript"></script>                      
