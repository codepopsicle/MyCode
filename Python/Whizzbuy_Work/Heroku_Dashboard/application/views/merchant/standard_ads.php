...
<?php endblock(); ?>
    ...
    <!-- BEGIN CONTENT -->
        <h3 class="page-title">Standard Advertisements</h3>
             <div class="page-bar">
                        ...
                        <div class="tab-pane active" id="standard_product">
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <!-- BEGIN FORM-->
                                    <?php echo form_open_multipart('merchant/sproduct',$attributes); ?>
                                        <div class="form-body">
                                            <input type="hidden" name="merchantc" value="<?php echo $merchantcode; ?>">
                                            <div class="form-group">
                                                <label class="control-label col-md-2">Default Date Ranges</label>
                                                <div class="col-md-5">
