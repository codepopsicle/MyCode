...
<?php endblock(); ?>
    ...
    <!-- BEGIN CONTENT -->
        ...
        <div class="row" >
            <div class="col-md-12">
                <!-- BEGIN ROW -->
                <div class="row">
                    <div class="col-md-6" id="transactions_metrics">
                        <input type="hidden" name="jsonarray" value="<?php echo htmlspecialchars($transaction_by_month_count,ENT_QUOTES); ?>" >
                        <!-- BEGIN CHART PORTLET-->
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-bar-chart font-green-haze"></i>
                                    <span class="caption-subject bold uppercase font-green-haze"> Number of transactions</span>
                                </div>
                                <div class="tools">
                                     <a href="<?php echo base_url('index.php/merchant/transactions_performance_metrics') ?>"><label class="btn red btn-outline btn-circle btn-sm">
                                    View More</label></a>
                                </div>
                            </div>
                    ...
                    <!-- END CHART PORTLET-->
                    <div class="col-md-6" id="unit_sold_metrics">
                        <input type="hidden" name="jsonarray" 
                        value="<?php echo htmlspecialchars($unit_sold_by_month_count,ENT_QUOTES); ?>" >
                        <!-- BEGIN CHART PORTLET-->
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-bar-chart font-green-haze"></i>
                                    <span class="caption-subject bold uppercase font-green-haze"> Total units sold</span>
                                </div>
                                <div class="tools">
                                     <a href="<?php echo base_url('index.php/merchant/unit_sold_performance_metrics') ?>"><label class="btn red btn-outline btn-circle btn-sm">
                                    View More</label></a>
                                </div>
                            </div>
                            <div class="portlet-body">
        ...
        <div class="row">
            <div class="col-md-6" id="revenue_metrics">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-bar-chart font-green-haze"></i>
                            <span class="caption-subject bold uppercase font-green-haze"> Gross Revenue</span>
                        </div>
                        <div class="tools">
                             <a href="<?php echo base_url('index.php/merchant/gross_revenue_performance_metrics') ?>"><label class="btn red btn-outline btn-circle btn-sm">
                                View More</label></a>
                        </div>
                    </div>
                    <div class="portlet-body">
            ...
            <div class="col-md-6" id="product_metrics">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        ...
                        <div class="tools">
                             <a href="<?php echo base_url('index.php/merchant/product_performance_metrics') ?>"><label class="btn red btn-outline btn-circle btn-sm">
                                View More</label></a>
                        </div>
                    </div>
                    <div class="portlet-body">
    ...
    <?php startblock('page_level_scripts'); ?>
      <!-- BEGIN  PAGE LEVEL SCRIPTS -->                                  
        <script src="<?php echo base_url('assets/pages/scripts/pmetrics.js'); ?>" type="text/javascript"></script>                                          
        <!-- END PAGE LEVEL PLUGINS -->
    <?php endblock(); ?>
