                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-blue-sharp bold uppercase">City</span>
                                    </div>
                                    <div class="actions">
                                    ...
                                    <div class="modal fade addcity" tabindex="-100" role="dialog" aria-labelledby="myLargeModalLabel">
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <form class="form-inline" action="<?php echo base_url('index.php/update/city_add') ?>" method="post" style="padding: 20px; margin-left: 20%;">
                                ...
                                <div class="portlet-body">
                                    <table class="table" border=0>
                                      ...
                                      <tr>
                                        ...
                                        <td><button class="btn green btn-outline sbold uppercase" data-toggle="modal" data-target="#<?php echo $row->city; ?>">Modify</button>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('index.php/update/city_delete/'.$row->id) ?>" id="demo_3" class="btn red btn-outline sbold uppercase" >Delete</a></td>
                                        </tr>
                                      <div class="modal fade" id="<?php echo $row->city; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog modal-lg" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <form class="form-horizontal" action="<?php echo base_url('index.php/update/city_update'); ?>" method="post">
