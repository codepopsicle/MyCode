                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_0">
                                        <div class="portlet box red ">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form id="countdown" action="<?php echo base_url('index.php/update/countdown_timer_add') ?>" method="post" class="form-horizontal form-bordered form-label-stripped">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">PreLaunch Description</label>
                                                            <div class="col-md-9">
                                                                <input type="text"  name="prelaunch" class="form-control" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="PostLaunchDescription" class="form-control" />
                                                                <span class="help-block"> Link to the app’s Play Store link </span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Run Period</label>
                                                            <div class="col-md-9">
                                                                <input type="number" name="RunPeriod" class="form-control" />
                                                                <span class="help-block"> Number of days </span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Target App Version</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="TargetAppVersion" class="form-control" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="hidden" id="LaunchDate" name="LaunchDate" >
                                                                <a href="javascript:;" id="dob" data-type="date" data-viewformat="yyyy-mm-dd" data-pk="1" data-placement="right"> 2013-02-15 </a>
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <button  class="btn green" onclick="DoSubmit()">
                                    ...
                                    <div class="tab-pane " id="tab_1">
                                        <div class="portlet light portlet-fit ">
					                        <div class="portlet-title">
					                            <div class="caption">
					                                <i class="icon-diamonds font-dark"></i>
					                        ...
					                        <div class="row">
						                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						                            <div class="dashboard-stat blue">
						                                ...
						                                <div class="details">
						                                    <div class="number">
						                                        <span data-counter="counterup" data-value="1349"><a data-name="premium_period" data-url="<?php echo base_url('index.php/update/premium_days_update') ?>" style="color: #FFFFFF" href="javascript:;" id="username" data-type="number" data-pk="1" data-original-title="Enter Premium Period"> <?php print_r($adperiod[0][0]['Period']) ?> </a></span>Days
						                                    </div>
						                                    <div class="desc"> Premium Period </div>
						                                </div>
						                                <a class="more" href="javascript:;"> Currently runs for <?php print_r($adperiod[0][0]['Period']) ?> days
						                                </a>
						                            </div>
						                        </div>
						                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
							                        <div class="dashboard-stat green">
						                                ...
						                                <div class="details">
						                                    <div class="number">
						                                        <span data-counter="counterup" data-value="12,5"><a style="color: #FFFFFF" data-name="standard_period" data-url="<?php echo base_url('index.php/update/standard_days_update') ?>" href="javascript:;" id="comments" data-type="number" data-pk="1" data-placeholder="Enter Standard Period." data-original-title="Enter comments"><?php print_r($adperiod[1][0]['Period']) ?>
					                                                        </a></span>Days </div>
						                                    <div class="desc"> Standard Period </div>
						                                </div>
						                                <a class="more" href="javascript:;"> Currently runs for <?php print_r($adperiod[1][0]['Period']) ?> days
						                                </a>
						                            </div>
						                        </div>
						                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						                            <div class="dashboard-stat purple">
						                                ...
						                                <div class="details">
						                                    <div class="number"> +
						                                        <span data-counter="counterup" data-value="89"></span><a data-name="premium_count" data-url="<?php echo base_url('index.php/update/premium_count_update') ?>" style="color: #FFFFFF" href="javascript:;" id="vacation" data-type="number" data-pk="1" data-placement="right" data-original-title="Premium ads count"> <?php echo($premiumadcount[0]['Count']) ?> </a></div>
						                                    <div class="desc"> Premium Count </div>
						                                </div>
						                                <a class="more" href="javascript:;"> Currently <?php echo($premiumadcount[0]['Count']) ?> Premium ads are displayed
						                                </a>
						                            </div>
						                        </div>
						                    </div>
...
<![endif]-->
        ...
        function DoSubmit(){
        	var a = document.getElementById("LaunchDate");
	      	a.value = document.getElementById("dob").innerHTML;//'2000-09-19';//document.dob.value;
	      	document.getElementById("countdown").submit();
	      }
