	...
	def post(self):
		try:
			...
			if validateEmail(_userEmailID):
				...
				cursor = conn.cursor() 
				cursor.callproc('whizzbuytest.spCreateCustomer',(_userMobile,_userPassword,_userFirstName,_userLastName,_userEmailID,_userLifeStyle, _userDOB, otp, c_time, _userPlatform))
