...
class ApiTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        app.config['MYSQL_DATABASE_PASSWORD'] = 'pritishkishore'
    ...
    def test_FetchtransactionHistoryList(self):
        ...
        reqdata=[{'Status':'200'},{'Message':'Itemized receipt fetch successful'},{'trandate': '2016-02-04 04:09:30'},{'area':'GKM'},
                 ...
                 {'ItemBill':[{'isPosted':'0','quant':'2','val':40.0,'desc':'Nutties','barcode': 578901},
                              {'isPosted':'1','quant':'3','val': 25.0,'desc':'DairyMilk','barcode': 45127}]}]
        self.assertEqual(json.loads(response.data),reqdata)
...
result = runner.run(unittest.makeSuite(ApiTestCase))
