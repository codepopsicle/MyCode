...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url('index.php/login/validate_credentials'); ?>" method="post">
                ...
                <!-- <div class="">
                    <p> Don't have an account yet ?&nbsp;
                        <a href="<php echo base_url('index.php/register/reg_admin'); ?>" id="register-btn"> Create an account </a>
                    </p>
                </div> -->
            </form>
            <!-- END LOGIN FORM -->
            ...
            <form class="register-form" action="<?php echo base_url('index.php/register/reg_admin'); ?>" method="post">
                <h3>Sign Up</h3>
