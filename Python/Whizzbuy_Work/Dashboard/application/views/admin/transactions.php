	                                                ...
	                                                <td> 
                                                        <?php
                                                            ...
                                                            foreach ($obj->{'receiptString'}->{'Items'} as $item) {
                                                                    ...
                                                                    # code...
                                                                echo('<table>');
                                                                    echo "<tr><td><br>item: ".$item->{'Item'}."</td>";
                                                                    echo "<td><br>Price: ".$item->{'Price'}."</td>";
                                                                    echo "<td><br>Quantity: ".$item->{'Quantity'}."</td>";
                                                                    echo "<td><br>Total: ".$item->{'TotalValue'}."</td>";
                                                                echo('</table>');
                                                                }
                                                            foreach ($obj->{'receiptString'}->{'Total'} as $Total) {
                                                                    # code...
                                                                    echo '<br>Gross : '.$Total->{'Gross'};
                                                                }
