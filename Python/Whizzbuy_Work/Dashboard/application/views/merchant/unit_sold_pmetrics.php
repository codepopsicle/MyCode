            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                         ...
                         <li class="nav-item ">
                            <a href="<?php echo base_url('index.php/merchant/unit_sold') ?>" class="nav-link nav-toggle">
                                <i class="icon-credit-card"></i>
                                <span class="title">unit_sold</span>
                                <span class="arrow"></span>
                            </a>
                        </li>
                         <li class="nav-item ">
    ...
    <!-- BEGIN CONTENT -->
        ...
        <!-- BEGIN TAB PORTLET-->
                            ...
                            <div class="caption" style="height: 40px">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase">unit sold</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="portlet_tab2">
                                            <div class="row" id="unit_sold_metrics_month">
                                                <script src="<?php echo base_url('assets/global/plugins/jquery.min.js'); ?>" type="text/javascript"></script>
                                                <input type="hidden" name="jsonarray" value="<?php echo htmlspecialchars($unit_sold_by_month_count,ENT_QUOTES); ?>" >
                                                <div class="col-md-12">
                                                    <!-- BEGIN ROW -->
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="portlet light bordered">
                                                                <div class="portlet-title">
                                                                    <div class="caption">
                                                                        ...
                                                                        <span class="caption-subject bold uppercase font-green-haze"> Number of unit_sold</span>
                                                                    </div>
                                                                   
                                                                </div>
                                                                <div class="portlet-body">
                                                                    <div id="chart_2_2" class="chart" style="height: 300px;"> </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- END CHART PORTLET-->
                                        ...
                                        <div class="tab-pane" id="portlet_tab3">
                                            <div class="row" id="unit_sold_metrics_day">
                                                <script src="<?php echo base_url('assets/global/plugins/jquery.min.js'); ?>" type="text/javascript"></script>
                                                <input type="hidden" name="jsonarray" value="<?php echo htmlspecialchars($unit_sold_by_day_count,ENT_QUOTES); ?>" >
                                                <div class="col-md-12">
                                                    <!-- BEGIN ROW -->
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="portlet light bordered">
                                                                ...
                                                                <div class="portlet-body">
                                                                    <div id="chart_2_3" class="chart" style="height: 300px;"> </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- END CHART PORTLET-->
...
<script src="<?php echo base_url('assets/global/scripts/daterangepicker.js'); ?>" type="text/javascript"></script>
 ...
 <script src="<?php echo base_url('assets/global/plugins/highcharts/highstock.js'); ?>" type="text/javascript"></script>
  ...
  "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    ...
    $('#start').val(startdate);
    $('#end').val(enddate);
    $("#form1").attr("action","<?php echo base_url('index.php/merchant/unit_sold_performance_metrics_1'); ?>");
    ...
    <?php startblock('page_level_scripts'); ?>
      <!-- BEGIN  PAGE LEVEL SCRIPTS -->                                  
      <script src="<?php echo base_url('assets/pages/scripts/unit_sold_pmetrics.js'); ?>" type="text/javascript"></script>                                          
        <!-- END PAGE LEVEL PLUGINS -->
    <?php endblock(); ?>
