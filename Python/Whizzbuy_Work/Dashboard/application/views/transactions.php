...
<html lang="en">
  ...
  <head>
        ...
        <script src="<?php echo base_url('dist/js/jquery.tablesorter.widgets.js'); ?>"></script>
    ...
    <header  id="wrap">
        <div class="head-navbar" style="background:#99FFCC;">
            ...
            <ul class="nav nav-tabs" style="padding-left:20px;">
              ...
              <li role="presentation" class="active"><a href="<?php echo base_url('index.php/home/transactions') ?>"><i class="fa fa-inr"></i> Transactions</a></li>
      ...
      <h3>Transactions</h3 id="wrap">
        <div class="row">
            ...
            <div class="col-md-9">
              ...
              <?php $cnt=1; ?>
              <table class="table table-hover table-list-search tablesorter" id="wrap">
                <tr>
                  <th>S.No.</th>
