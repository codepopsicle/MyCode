...
<html lang="en">
  ...
  <head>
        ...
        <title>WhizzBuy | Standard Ads</title>
        ...
        <div class="head-navbar" style="background:#99FFCC;">
            ...
            <ul class="nav nav-tabs" style="padding-left:20px;">
              ...
              <li role="presentation" class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li role="presentation" class="active"><a href="<?php echo base_url('index.php/home/standard_ads') ?>">Standard</a></li>
        ...
        <div id="estandard" class="tab-pane">
                  ...
                  <input type="hidden" name="merchantc" value="<?php echo $merchantcode; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="bname" placeholder="Name of the Event" data-validate="required">
                      </div>
                    </div>
