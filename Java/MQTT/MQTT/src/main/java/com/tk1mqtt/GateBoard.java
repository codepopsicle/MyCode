...
public class GateBoard extends JFrame implements MqttCallback {
    ...
    private String gate_global = "";

    public GateBoard(String gate) {
        gate_global = gate;
        ...
        setTitle("Arrivals and Departures at Gate - " + gate);
        ...
        for(int i=0; i<flist.size(); i++) {
            ...
            ArrivalGate = values[10];

            /*logic for displaying only arrivals or departures pertaining to selected Gate*/
            if((ArrivalGate.equals(gate))||(DepartureGate.equals(gate))){
    ...
    public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
        ...
        while (in.available() > 0) {
            ...
            /*logic for displaying only arrivals or departures pertaining to selected Gate*/
            if((ArrivalGate.equals(gate_global))||(DepartureGate.equals(gate_global))){
