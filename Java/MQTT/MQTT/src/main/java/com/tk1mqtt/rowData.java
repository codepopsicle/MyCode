...
public class rowData extends JFrame {
    ...
    public rowData(String S,final String username, String Direction)
    {
        if(Direction.equals("Arrival")) {
        setTitle("Enter only arrival flight details");
    }
    else{
        setTitle("Enter only departure flight details");
    }
        ...
        btnConfirm.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                if(Direction.equals("Arrival")){
                    ...
                    //departure gate
                    values = values + textField_8.getText() + ";";
                    //estimated departure
